...
contract DeployMigrationWithVesting is Script {
    ...
    function run() external {
        ...
        VanaMigrationBridge migrationBridge = new VanaMigrationBridge(rdatToken, admin, validators);
        console2.log("VanaMigrationBridge deployed at:", address(migrationBridge));

        // 2. Deploy MigrationBonusVesting contract
        MigrationBonusVesting bonusVesting = new MigrationBonusVesting(rdatToken, admin);
