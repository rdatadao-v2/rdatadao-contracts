...
contract TestDeployedContracts is Script {
    function run() external view {
        ...
        console2.log(
            "  Admin:", treasury.hasRole(treasury.DEFAULT_ADMIN_ROLE(), 0x29CeA936835D189BD5BEBA80Fe091f1Da29aA319)
        );
        ...
        console2.log(
            "  Admin has GUARDIAN role:",
            emergencyPause.hasRole(emergencyPause.GUARDIAN_ROLE(), 0x29CeA936835D189BD5BEBA80Fe091f1Da29aA319)
        );
