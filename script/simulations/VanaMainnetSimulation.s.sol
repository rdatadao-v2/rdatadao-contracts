...
contract VanaMainnetSimulation is Script {
    function run() external view {
        ...
        console2.log("  Admin (Multisig):", vm.envOr("ADMIN_ADDRESS", address(0x29CeA936835D189BD5BEBA80Fe091f1Da29aA319)));
        console2.log("  Treasury (Multisig):", vm.envOr("TREASURY_ADDRESS", address(0x29CeA936835D189BD5BEBA80Fe091f1Da29aA319)));
