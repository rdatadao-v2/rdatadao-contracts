...
contract DeployRDATUpgradeable is Script {
    function run() external {
        ...
        require(block.chainid == 1480 || block.chainid == 14800, "RDAT V2 can only be deployed to Vana networks");
    ...
    function dryRun() external view {
        ...
        require(block.chainid == 1480 || block.chainid == 14800, "RDAT V2 dry run only for Vana networks");
