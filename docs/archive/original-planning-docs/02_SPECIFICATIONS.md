# 📋 RDAT V2 Beta Smart Contract Specifications (PLANNING DOCUMENT)

> ⚠️ **Note**: This is the original planning document from August 2025. For the actual deployed system specifications, see **[CURRENT_SPECIFICATIONS.md](./CURRENT_SPECIFICATIONS.md)**
