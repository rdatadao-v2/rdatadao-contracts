...
contract RewardsManagerTest is Test {
    ...
    event ProgramRegistered(
        uint256 indexed programId, address indexed rewardModule, address indexed rewardToken, string name
    );
    ...
    function test_RegisterProgram_InvalidModule() public {
        ...
        rewardsManager.registerProgram(address(0), "Invalid Module", 0, 0);
    ...
    function test_RegisterProgram_WithStartTimeAndDuration() public {
        ...
        uint256 programId =
            rewardsManager.registerProgram(address(rdatModule), "RDAT Staking Rewards", futureStart, duration);
    ...
    function test_UpdateProgramStatus() public {
        ...
        uint256 programId = rewardsManager.registerProgram(address(vrdatModule), "vRDAT Rewards", 0, 0);
    ...
    function test_NotifyStake() public {
        ...
        uint256 expectedVRDAT =
            (STAKE_AMOUNT * stakingPositions.lockMultipliers(stakingPositions.MONTH_1())) / stakingPositions.PRECISION();
    ...
    function test_ClaimRewards_SingleProgram() public {
        ...
        vm.prank(admin);
        uint256 programId = rewardsManager.registerProgram(address(rdatModule), "RDAT Staking Rewards", 0, 0);
    ...
    function test_ClaimRewards_MultiplePrograms() public {
        ...
        vm.startPrank(admin);
        rewardsManager.registerProgram(address(vrdatModule), "vRDAT Governance Rewards", 0, 0);

        rewardsManager.registerProgram(address(rdatModule), "RDAT Staking Rewards", 0, 0);
        vm.stopPrank();
    ...
    function test_NotifyRevenueReward_NoProgramMatch() public {
        ...
        vm.prank(admin);
        rewardsManager.registerProgram(address(rdatModule), "Different Name", 0, 0);
    ...
    function test_GetProgram() public {
        vm.prank(admin);
        uint256 programId =
            rewardsManager.registerProgram(address(vrdatModule), "Test Program", block.timestamp + 1 days, 30 days);
    ...
    function test_RegisterProgram_InvalidToken() public {
        ...
        rewardsManager.registerProgram(address(invalidModule), "Invalid", 0, 0);
    }
...
contract MockInvalidModule is IRewardModule {
    ...
    function calculateRewards(address, uint256) external pure returns (uint256) {
        return 0;
    }

    function claimRewards(address, uint256) external pure returns (uint256) {
        return 0;
    }
    ...
    function totalDistributed() external pure returns (uint256) {
        return 0;
    }

    function remainingAllocation() external pure returns (uint256) {
        return 0;
    }
