...
contract TokenVestingTest is Test {
    ...
    function setUp() public {
        ...
        ERC1967Proxy rdatProxy = new ERC1967Proxy(
            address(rdatImpl), abi.encodeCall(rdatImpl.initialize, (treasuryMultisig, admin, address(0x200)))
        );
    ...
    function test_GetVestingSchedule() public {
        ...
        (uint256 eligibility, uint256 cliffEnd, uint256 vestingEnd) = tokenVesting.getVestingSchedule();
