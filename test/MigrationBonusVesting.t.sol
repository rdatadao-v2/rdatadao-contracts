...
contract MigrationBonusVestingTest is Test {
    ...
    function setUp() public {
        ...
        bytes memory treasuryInitData =
            abi.encodeWithSelector(TreasuryWallet.initialize.selector, treasuryAdmin, expectedRdatProxy);
        ...
        bytes memory rdatInitData =
            abi.encodeWithSelector(RDATUpgradeable.initialize.selector, address(treasury), admin, migrationContract);
    ...
    function test_MigrationWithoutBonusContract() public {
        ...
        VanaMigrationBridge bridgeNoBonus = new VanaMigrationBridge(address(rdat), admin, validators);
