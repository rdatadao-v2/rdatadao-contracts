...
contract PositionLimitCoreTest is Test {
    ...
    function setUp() public {
        ...
        ERC1967Proxy rdatProxy =
            new ERC1967Proxy(address(rdatImpl), abi.encodeCall(rdatImpl.initialize, (treasury, admin, address(0x100))));
        ...
        ERC1967Proxy stakingProxy = new ERC1967Proxy(
            address(stakingImpl), abi.encodeCall(stakingImpl.initialize, (address(rdat), address(vrdat), admin))
        );
