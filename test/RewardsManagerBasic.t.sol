...
contract RewardsManagerBasicTest is Test {
    ...
    function test_RegisterMultiplePrograms() public {
        ...
        uint256 id1 = rewardsManager.registerProgram(address(vrdatModule), "vRDAT Rewards", 0, 0);

        uint256 id2 = rewardsManager.registerProgram(address(rdatModule), "RDAT Staking Rewards", 0, 0);
    ...
    function test_ProgramLifecycle() public {
        ...
        // Register
        uint256 programId = rewardsManager.registerProgram(address(vrdatModule), "Test Program", 0, 0);
    ...
    function test_ProgramWithFutureStart() public {
        ...
        uint256 programId = rewardsManager.registerProgram(address(rdatModule), "Future Program", futureTime, 30 days);
