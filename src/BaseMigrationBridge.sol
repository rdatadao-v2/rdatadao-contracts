...
contract BaseMigrationBridge is IMigrationBridge, AccessControl, Pausable, ReentrancyGuard {
    ...
    function CHALLENGE_PERIOD() external pure override returns (uint256) { return 0; }
    function MIN_VALIDATORS() external pure override returns (uint256) { return 0; }
    function CONFIRMATION_BLOCKS() external pure override returns (uint256) { return 0; }
    function DAILY_LIMIT() external pure override returns (uint256) { return 0; }
    function WEEK_1_2_BONUS() external pure override returns (uint256) { return 0; }
    function WEEK_3_4_BONUS() external pure override returns (uint256) { return 0; }
    function WEEK_5_8_BONUS() external pure override returns (uint256) { return 0; }
    function BASIS_POINTS() external pure override returns (uint256) { return 10000; }
}