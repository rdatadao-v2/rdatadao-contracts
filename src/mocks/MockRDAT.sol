...
/**
 * @title MockRDAT
 * @notice Mock version of the existing RDAT token on Base mainnet (0x4498cd8ba045e00673402353f5a4347562707e7d)
 * @dev This contract replicates the exact functionality of the existing RDAT token for testing purposes
 */
contract MockRDAT is ERC20, ERC20Permit, ERC20Votes, Ownable2Step {
    ...
    constructor(address ownerAddress) ERC20("RData", "RDAT") ERC20Permit("RData") Ownable(ownerAddress) {
