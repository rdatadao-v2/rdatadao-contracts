...
contract Create2Factory {
     ...
     * @return The computed address
     */
    function computeAddressWithDeployer(bytes memory bytecode, bytes32 salt, address deployer)
        public
        pure
        returns (address)
    {
     ...
     * @return deployed The address of the deployed contract
     */
    function deployWithConstructor(bytes memory bytecode, bytes32 salt, bytes memory constructorArgs)
        external
