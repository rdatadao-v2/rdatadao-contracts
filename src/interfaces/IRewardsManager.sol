...
interface IRewardsManager {
    ...
    event RewardsClaimed(address indexed user, uint256 indexed stakeId, ClaimInfo[] claims);
    ...
    function notifyUnstake(address user, uint256 stakeId, bool emergency) external;
